...
from Profiles.views import CreateProfile,accountActivity, AccountView, success, UpdateprofileView, Deleteprofile, ViewProfile, \
...
urlpatterns = [
    ...
    path("activity",accountActivity.as_view(),name="activity")
